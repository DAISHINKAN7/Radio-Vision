#!/bin/bash
# Master training script - Run all models in sequence
...
TRAIN_RADIO="dataset/train/radio"
TRAIN_OPTICAL="dataset/train/optical"
VAL_RADIO="dataset/val/radio"
VAL_OPTICAL="dataset/val/optical"
...
# Note: You'll need to adapt the evaluation script for your specific models
